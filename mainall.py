...
def page2():
    ...
    question_2 = st.markdown("""
        <div>
            <p style='color: black; font-size: 26px;'> 2. Imagine now you want to buy a phone good at taking photos, so you see the following six advertisements in the search engine, which one (which ones) do you want to click the most? </p>
            <p style='color: black; font-size: 26px;'> Please read the six advertisements and answer the questions.</p>
...
def page3():
    ...
    question_3 = st.markdown("""
        <div>
            <p style='color: black; font-size: 26px;'> 3. Imagine now you want to buy books in the genre of romance, so you see the following six advertisements in the search engine, which one (which ones) do you want to click the most? </p>
            <p style='color: black; font-size: 26px;'> Please read the six advertisements and answer the questions.</p>
...
def page4():
    ...
    question_4 = st.markdown("""
        <div>
            <p style='color: black; font-size: 26px;'> 4. Imagine now you want to buy noise canceling headphones, so you see the following six advertisements in the search engine, which one (which ones) do you want to click the most? </p>
            <p style='color: black; font-size: 26px;'> Please read the six advertisements and answer the questions.</p>
...
def page5():
    ...
    question_5 = st.markdown("""
        <div>
            <p style='color: black; font-size: 26px;'> 5. Imagine now you want to buy a sheath dress, so you see the following six advertisements in the search engine, which one (which ones) do you want to click the most? </p>
            <p style='color: black; font-size: 26px;'> Please read the six advertisements and answer the questions.</p>
...
def page6():
    ...
    question_6 = st.markdown("""
        <div>
            <p style='color: black; font-size: 26px;'> 6. Imagine now you want to buy fantasy books, so you see the following six advertisements in the search engine, which one (which ones) do you want to click the most? </p>
            <p style='color: black; font-size: 26px;'> Please read the six advertisements and answer the questions.</p>
...
def page10():
    ...
    question_10 = st.markdown("""
        <div>
            <p style='color: black; font-size: 26px;'> 10. Imagine now you want to buy a man's jacket, so you see the following six advertisements in the social media platform, which one (which ones) do you want to click the most? Please read the six advertisements and answer the questions.</p>
...
def page11():
    ...
    question_11 = st.markdown("""
        <div>
            <p style='color: black; font-size: 26px;'> 11. Imagine now you're hoping to spend a week on vacation with your family, so you see the following six advertisements in the social media platform, which one (which ones) do you want to click the most? Please read the six advertisements and answer the questions.</p>
