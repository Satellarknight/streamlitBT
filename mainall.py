...
def page0():
    ...
    question_1 = st.markdown("""
        <div>
            <p style='color: black; font-size: 26px;'> Thank you for participating in our user study. This user study is part of a Bachelor Thesis. We trained a language model that can output different styles of text for online advertisements, and we want to guide and help advertisers and marketers through this model. There are three tasks in this survey. You need to complete all the three tasks. There are 11 questions in total.</p>
...
def page2():
    ...
    question_2 = st.markdown("""
        <div>
            <p style='color: black; font-size: 26px;'> 2. Imagine now you want to buy a phone good at taking photos, so you see the following six advertisements in the search engine, which one (which ones) do you want to click the most? Please read the six advertisements and answer the questions.</p>
...
def page3():
    ...
    question_3 = st.markdown("""
        <div>
            <p style='color: black; font-size: 26px;'> 3. Imagine now you want to buy books in the genre of romance, so you see the following six advertisements in the search engine, which one (which ones) do you want to click the most? Please read the six advertisements and answer the questions.</p>
...
def page4():
    ...
    question_4 = st.markdown("""
        <div>
            <p style='color: black; font-size: 26px;'> 4. Imagine now you want to buy noise canceling headphones, so you see the following six advertisements in the search engine, which one (which ones) do you want to click the most? Please read the six advertisements and answer the questions.</p>
...
def page5():
    ...
    question_5 = st.markdown("""
        <div>
            <p style='color: black; font-size: 26px;'> 5. Imagine now you want to buy a sheath dress, so you see the following six advertisements in the search engine, which one (which ones) do you want to click the most? Please read the six advertisements and answer the questions.</p>
...
def page6():
    ...
    question_6 = st.markdown("""
        <div>
            <p style='color: black; font-size: 26px;'> 6. Imagine now you want to buy fantasy books, so you see the following six advertisements in the search engine, which one (which ones) do you want to click the most? Please read the six advertisements and answer the questions.</p>
...
def page7():
    ...
    question_7 = st.markdown("""
        <div>
            <p style='color: black; font-size: 26px;'> 7. Imagine you are a male college student names James who usually likes to play the piano. You have three emails in your mailbox selling music lessons. Your task is to read three emails and answer questions.</p>
        </div>
    """, unsafe_allow_html=True)
...
def page8():
    ...
    question_8 = st.markdown("""
        <div>
            <p style='color: black; font-size: 26px;'> 8. Imagine you are a female conpany employees names Lina who wants to relax. You have three emails in your mailbox selling vacation plans. Your task is to read three emails and answer questions.</p>
        </div>
    """, unsafe_allow_html=True)
...
def page9():
    ...
    question_9 = st.markdown("""
        <div>
            <p style='color: black; font-size: 26px;'> 9. Imagine you are a middle-aged female employee names Elice. You have three emails in your mailbox selling vitamin C health products. Your task is to read three emails and answer questions.</p>
        </div>
    """, unsafe_allow_html=True)
...
def page10():
    ...
    question_10 = st.markdown("""
        <div>
            <p style='color: black; font-size: 26px;'> 10. Imagine now you want to buy a man's jacket, so you see the following six advertisements in the social media platform, which one (which ones) do you want to click the most? 3.Please read the six advertisements and answer the questions.</p>
...
def page11():
    ...
    question_11 = st.markdown("""
        <div>
            <p style='color: black; font-size: 26px;'> 11. Imagine now you're hoping to spend a week on vacation with your family, so you see the following six advertisements in the social media platform, which one (which ones) do you want to click the most? 3.Please read the six advertisements and answer the questions.</p>
