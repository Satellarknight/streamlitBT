...
def page0():
    ...
    question_1 = st.markdown("""
        <div>
            <p style='color: black; font-size: 26px;'> Thank you for participating in our user study. There are 11 questions in this survey. </p>
            <p style='color: black; font-size: 26px;'> ------------------------------------------------------ </p>
            <p style='color: black; font-size: 24px;'> The first type of questions is about online advertising, which simulates the online advertisements that may appear when we use Google search engine to search for goods. Some of them are generated by our model.</p>
            <p style='color: brown; font-size: 24px;'> Each advertisement has two options, "I will click on this web page." means that you want to click it subjectively, and "This Ad is attractive." means that you think the advertisement itself is attractive to other people. You can of course choose both or neither. </p>
        </div>
...
def page2():
    ...
    question_2 = st.markdown("""
        <div>
            <p style='color: black; font-size: 26px;'> 2. Now you want to buy a phone good at taking photos, so you see the following six advertisements in the search engine, which one (which ones) do you want to click the most?</p>
...
def page3():
    ...
    question_3 = st.markdown("""
        <div>
            <p style='color: black; font-size: 26px;'> 3. Now you want to buy books in the genre of romance, so you see the following six advertisements in the search engine, which one (which ones) do you want to click the most?</p>
...
def page4():
    ...
    question_4 = st.markdown("""
        <div>
            <p style='color: black; font-size: 26px;'> 4. Now you want to buy noise canceling headphones, so you see the following six advertisements in the search engine, which one (which ones) do you want to click the most?</p>
...
def page5():
    ...
    question_5 = st.markdown("""
        <div>
            <p style='color: black; font-size: 26px;'> 5. Now you want to buy a sheath dress, so you see the following six advertisements in the search engine, which one (which ones) do you want to click the most?</p>
...
def page6():
    ...
    question_6 = st.markdown("""
        <div>
            <p style='color: black; font-size: 26px;'> 6. Now you want to buy fantasy books, so you see the following six advertisements in the search engine, which one (which ones) do you want to click the most?</p>
...
def page02():
    ...
    question_7 = st.markdown("""
        <div>
            <p style='color: black; font-size: 24px;'> The second type of questions is about marketing emails. There are three emails, one is general marketing emails, which is for all user groups. The other two are personalized marketing emails, which are customized for different user profiles.</p>
            <p style='color: brown; font-size: 24px;'> Each advertisement has two options, "I think this email is relevant to me." means that you subjectively believe that this email contains the information you want to know., and "This email is attractive." means that you think the email itself is attractive to other people. You can of course choose both or neither.</p>
        </div>
    """, unsafe_allow_html=True)
...
def page7():
    ...
    question_7 = st.markdown("""
        <div>
            <p style='color: black; font-size: 26px;'> 7. Imagine you are a male college student names James who usually likes to play the piano. You have three emails in your mailbox selling music lessons.</p>
        </div>
    """, unsafe_allow_html=True)
...
def page8():
    ...
    question_8 = st.markdown("""
        <div>
            <p style='color: black; font-size: 26px;'> 8. Imagine you are a female conpany employees names Lina who wants to relax. You have three emails in your mailbox selling vacation plans.</p>
        </div>
    """, unsafe_allow_html=True)
...
def page9():
    ...
    question_9 = st.markdown("""
        <div>
            <p style='color: black; font-size: 26px;'> 9. Imagine you are a middle-aged female employee names Elice. You have three emails in your mailbox selling vitamin C health products.</p>
        </div>
    """, unsafe_allow_html=True)
...
def page03():
    ...
    question_10 = st.markdown("""
        <div>
            <p style='color: black; font-size: 24px;'> The third type of questions is about online advertising, simulating the online advertising that might appear when we use social media. Some of them are generated by our model.</p>
...
def page10():
    ...
    question_10 = st.markdown("""
        <div>
            <p style='color: black; font-size: 26px;'> 10. Now you want to buy a man's jacket, so you see the following six advertisements in the social media platform, which one (which ones) do you want to click the most?</p>
...
def page11():
    ...
    question_11 = st.markdown("""
        <div>
            <p style='color: black; font-size: 26px;'> 11. Now you're hoping to spend a week on vacation with your family, so you see the following six advertisements in the social media platform, which one (which ones) do you want to click the most?</p>
