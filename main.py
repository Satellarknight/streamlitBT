...
def page0():
    ...
    question_1 = st.markdown("""
        <div>
            <p style='color: black; font-size: 26px;'> Thank you for participating in our user study. This user study is part of an Bachelor Thesis. We trained a language model that can output different styles of online advertisements, and we want to guide and help advertisers and marketers through this. </p>
            <p style='color: black; font-size: 26px;'> There are three tasks in this survey, some advertisements and emails are generated by artificial intelligence (our model).</p>
...
def page7():
    ...
    email_preview_7_0 = """ personalized email 1
    ## The Spring Sale from Musecore!  ##
    ...
    The Spring Sale is here! Don't miss out on MuseScore annual subscription:

    Access to 45,000+ scores collection licensed from famous print music publishers. 

    Download and print from the collection of more than 1,600,000 scores created by the trusted community.

    Ad-free experience.

    Advanced tools to sharpen your playing skills.
    ...
    option_7_000 = st.checkbox("personalized email 1", key='question_7_option_000')
...
def page8():
    ...
    email_preview_8_0 = """ personalized email 1
    ...
    option_8_000 = st.checkbox("personalized email 1", key='question_8_option_000')
...
def page9():
    ...
    email_preview_9_0 = """ personalized email 1
    ...
    option_9_000 = st.checkbox("personalized email 1", key='question_9_option_000')
...
def page03():
    ...
    question_10 = st.markdown("""
        <div>
            <p style='color: black; font-size: 24px;'> The third question is about online advertising, simulating the online advertising that might appear when we use social media. Some of them are generated by our model.</p>
...
def page10():
    ...
    question_10 = st.markdown("""
        <div>
            <p style='color: black; font-size: 26px;'> 3. Imagine now you want to buy a man's jacket, so you see the following six advertisements in the social media platform, which one (which ones) do you want to click the most?</p>
...
def page11():
    ...
    question_11 = st.markdown("""
        <div>
            <p style='color: black; font-size: 26px;'> 3. Imagine now you're hoping to spend a week on vacation with your family, so you see the following six advertisements in the social media platform, which one (which ones) do you want to click the most?</p>
