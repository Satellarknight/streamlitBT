...
def page0():
    ...
    question_1 = st.markdown("""
        <div>
            <p style='color: black; font-size: 26px;'> Thank you for participating in our user study. There are three questions in this survey. </p>
            <p style='color: black; font-size: 26px;'> ------------------------------------------------------ </p>
            <p style='color: black; font-size: 24px;'> The first question is about online advertising, which simulates the online advertisements that may appear when we use Google search engine to search for goods. Some of them are generated by our model.</p>
...
def page2():
    ...
    question_2 = st.markdown("""
        <div>
            <p style='color: black; font-size: 26px;'> 1. Now you want to buy a phone good at taking photos, so you see the following six advertisements in the search engine, which one (which ones) do you want to click the most?</p>
...
def page4():
    ...
    question_4 = st.markdown("""
        <div>
            <p style='color: black; font-size: 26px;'> 1. Now you want to buy noise canceling headphones, so you see the following six advertisements in the search engine, which one (which ones) do you want to click the most?</p>
...
def page02():
    ...
    question_7 = st.markdown("""
        <div>
            <p style='color: black; font-size: 24px;'> The second question is about marketing emails. There are three emails, one is general marketing emails, which is for all user groups. The other two are personalized marketing emails, which are customized for different user profiles.</p>
...
def page7():
    ...
    question_7 = st.markdown("""
        <div>
            <p style='color: black; font-size: 26px;'> 2. Imagine you are a male college student names James who usually likes to play the piano. You have three emails in your mailbox selling music lessons.</p>
        </div>
    """, unsafe_allow_html=True)
